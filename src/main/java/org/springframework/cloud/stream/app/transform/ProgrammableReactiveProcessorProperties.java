...
/**
 * Configuration properties for the Programmable Reactive Transform Processor module.
 *
 * @author Andy Clement
 * @author Mark Fisher
 */
@ConfigurationProperties
public class ProgrammableReactiveProcessorProperties {
	 ...
	 */
	/**
	 * A code snippet that should return code that maps from a Flux to a Flux.
